...
public class OrganizationApiMetricsClient extends AbstractApimanClient {
	...
	private ApiMetrics getOrganizationApiMetrics(String organizationId, String apiId, String version, Date fromDate, Date toDate, METRICS_TYPE metricsType) {
	...
	private ApiMetricsList getOrganizationApiMetrics(String organizationId, String apiId, String version, Date fromDate, Date toDate, String interval, METRICS_TYPE metricsType) {
